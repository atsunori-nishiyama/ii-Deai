...
<div class="signupPage">
    ...
    <div class="container">
        ...
        @csrf
            ...
            <label for="file_photo" class="rounded_circle userProfileImg">
            ...
            <div class="form-group">
                ...
                <input type="password" name="password_confirmation" class="form-control" placeholder="パスワードを再入力してください">
            </div>
            <div class="form-group">
            ...
            <div class="form-group @error('self_introduction')has_error @enderror">
                <label>自己紹介文</label>
